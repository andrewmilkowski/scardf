...
// Dependencies 
  ...
  lazy val jena = "com.hp.hpl.jena" % "jena" % JENA_VERSION % "compile" 
  
// TODO (unclear why jena_2.6.3-sources.jar is being pulled, the same for iri)
// we bring jar directly from maven
  lazy val jenaFix = "com.hp.hpl.jena" % "jena" % JENA_VERSION % "compile->default" from "http://repo2.maven.org/maven2/com/hp/hpl/jena/jena/2.6.3/jena-2.6.3.jar" 
  lazy val jenaIriFix = "com.hp.hpl.jena" % "iri" % JENA_IRI_VERSION % "compile->default" from "http://repo2.maven.org/maven2/com/hp/hpl/jena/iri/0.8/iri-0.8.jar"

  lazy val jenaArq = "com.hp.hpl.jena" % "arq" % JENA_ARQ_VERSION % "compile->default"
